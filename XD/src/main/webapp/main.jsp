...
.green-bar {
    ...
    top: 343px;
    left: 0;
    border-bottom: 3px dotted #1A472A;
    border-top: 3px dotted #1A472A;
    clip-path: polygon(10% 0, 90% 0, 78% 50%, 90% 100%, 10% 100%, 22% 50%);
}
...
.btn-iniciar:active:before,
.btn-iniciar:active:after {
    background: rgba(0, 128, 2, 0.414);
}
...
<body>
    <header class="header">
        ...
        <a href="LogIn.html" class="btn"><button>Iniciar Sesión</button></a>
    </header>
    <section class="first-section">
        <div class="top-image">
            <img src="img/culebritica_panzona2.0.jpeg" alt="Restaurant La Culebrítica Panzona">
        </div> <br>
        <div class="top-bar">
            <h1>LA CULEBRÍTICA PANZONA</h1>
        </div>
        <div class="green-bar">
            <div>Restaurant de comida selvática</div>
        </div>

        <br>
        <img src="img/forestBG.jpeg" alt="BosqueBG" class="bottom-image">
        <div class="white-box">
            <div class="welcome-text">¡BIENVENID@ A LA CULEBRÍTICA PANZONA!</div>
            <form action="Login.jsp" method="get">
                <button type="submit" class="btn-iniciar">
                    <p>¡Haga una reservación!</p>
                </button>
            </form>
        </div>
    </section>
